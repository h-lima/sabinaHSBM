...
@article{lima2026sabinahsbm,
    title = {sabinaHSBM: An R package for link prediction and network reconstruction using Hierarchical Stochastic Block Models},
    author={Lima, Herlander and Morales-Barbero, Jennifer and Mateo, Rub{\'e}n G and Morales-Castilla, Ignacio and Rodr{\'\i}guez, Miguel A},
