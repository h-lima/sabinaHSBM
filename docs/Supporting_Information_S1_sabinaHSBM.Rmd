...
The *sabinaHSBM* package depends on various R and Python libraries, as well as system-level components — especially the `graph-tool` Python package.
 ...
 - For all other users — or to avoid configuration issues — a **ready-to-use Docker image** is available.  
   It includes all dependencies pre-installed, including the *sabinaHSBM* package.  
   See *Supporting Information S3* for instructions on how to use 
